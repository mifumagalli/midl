...
;             _extra=extra_key, outrbg=outrgb
;
; INPUTS: 
...
PRO rgbview, rr, gg, bb, sdss=sdss, gunn=gunn, $
             gamma=gamma, saturation=saturation, $
             contrast=contrast, low_cut=low_cut, $
             nodisplay=nodisplay, $
             rsig=rsig, gsig=gsig, bsig=bsig, $
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  IF max_color LT 255 THEN BEGIN
      print
      print,'Only got ',ntostr(max_color),' colors for display'
      print
  ENDIF 
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
      ...
      IF (max_color LE 255) OR (n_elements(giffile) NE 0) OR (NOT doX) THEN BEGIN 
          color_im = color_quan(ar, ag, ab, rmap, gmap, bmap)
      ENDIF 
      IF (n_elements(giffile) NE 0) AND (max_color LT 255) THEN BEGIN 
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
      ...
      IF NOT keyword_set(nodisplay) THEN BEGIN 
          ...
          IF nww EQ 0 THEN BEGIN 
              ...
              ENDIF 
          ENDIF 
          IF max_color LE 255 THEN black = color_im[ww[0]]$
          ELSE black = ar[ww[0]]
          ...
          ENDIF 
          IF max_color LE 255 THEN white = color_im[ww[0]]
