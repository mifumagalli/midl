...
;	/skipsize: use to delete line definine paper size
;       /resize set to a number allows to rescale the final file
...
pro ps_mod, filename, x0=x0, y0=y0, x1=x1, y1=y1, $
	...
	coords=coords, high=high, resize=resize
...
splog, 'Resize ', filename
spawn, 'convert -scale 60% '+filename+' tmp'+psname
spawn, 'mv tmp'+psname+' '+filename
endif
