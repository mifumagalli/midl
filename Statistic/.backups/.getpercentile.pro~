...
pro getpercentile, xvec, yvec,  xbin, dcperc, tfperc, median, sfperc, ntperc, NBIN=nbin, DELTABIN=deltabin   


if    N_params() LT 1  then begin 
          print, 'Syntax - ' +$
         'getpercentile, xvec, yvec, xbin, dcperc, tfperc, median, sfperc, ntperc, NBIN=nbin, DELTABIN=deltabin   (v1.1)'
      return
endif
...
IF KEYWORD_SET(DELTABIN) THEN NBIN=CEIL((MAX(xvec)-MIN(xvec))/DELTABIN)
