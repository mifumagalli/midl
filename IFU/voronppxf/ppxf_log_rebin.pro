...
;----------------------------------------------------------------------
pro ppxf_log_rebin, lamRange, spec, specNew, logLam, $
...
borders = ppxf_cap_range(lim[0],lim[1],n+1)               ; Linearly
logLim = alog(lim)
...
newBorders = exp(ppxf_cap_range(logLim[0],logLim[1],m+1)) ; Logarithmically
