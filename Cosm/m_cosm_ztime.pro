...
;-
;------------------------------------------------------------------------------
function m_cosm_funcztime, z
common cosmolgy_cmmn, cosm_dm, cosm_k, cosm_h, cosm_Ob, cosm_L, cosm_r, sigma_8
common cosmolgy_fztime, age

  return, m_cosm_time(z) - age
end


function m_cosm_ztime, t, H0=h0, INIT=init, _EXTRA=extra
...
common cosmolgy_fztime, age
  ...
  for jj=0L,nt-1 do begin
      ...
      z[jj] = fx_root([1.,50.,0.],'m_cosm_funcztime',/double)
  endfor
